...
// Custom distorted font for headers
const distortionSans = localFont({
  src: [
    {
      path: '../public/fonts/DistortionSans-Bold.woff2',
      weight: '700',
      style: 'normal',
    },
  ],
...
export default function ChaosLayout({
  ...
  return (
    <html 
      lang="en" 
      className={`${distortionSans.variable} ${inter.variable}`}
    ...
    >
      ...
      <body className="bg-void-black text-ghost-white antialiased overflow-x-hidden">
